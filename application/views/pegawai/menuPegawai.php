...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Petugas</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nip" placeholder="First Name" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="email" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
