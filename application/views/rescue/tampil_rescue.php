...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url_ba = "<?php echo site_url('Rescue/get_data_rescue/semua')?>";
        if (filtering=="tahun") {
            var url_ba = "<?php echo site_url('Rescue/get_data_rescue/tahun')?>";
        }else if(filtering=="bulan"){
            var url_ba = "<?php echo site_url('Rescue/get_data_rescue/bulan')?>";
        }else if(filtering=="hari"){
            var url_ba = "<?php echo site_url('Rescue/get_data_rescue/hari')?>";
        }
        ...
        var table = $('#table').DataTable({ 
            ...
            "buttons": [
                ...
                {
                    "extend": 'excel',
                    "messageTop": 'Laporan Penyelamatan'
                },
                {
                    "extend": 'pdf',
                    "exportOptions": {
